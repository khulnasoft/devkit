...
import (
	...
	cacheutil "github.com/khulnasoft/devkit/cache/util"
	...
	gwclient "github.com/khulnasoft/devkit/frontend/gateway/client"
	"github.com/khulnasoft/devkit/frontend/gateway/container"
	"github.com/khulnasoft/devkit/frontend/gateway/forwarder"
	pb "github.com/khulnasoft/devkit/frontend/gateway/pb"
	...
	llberrdefs "github.com/khulnasoft/devkit/solver/llbsolver/errdefs"
	opspb "github.com/khulnasoft/devkit/solver/pb"
...
func metadataMount(def *opspb.Definition) (*executor.Mount, func(), error) {
	...
	dir, err := os.MkdirTemp("", "devkit-metadata")
	if err != nil {
		return nil, nil, err
	}
	...
	return &executor.Mount{
			Src:      &bind{dir},
			Dest:     "/run/config/devkit/metadata",
			Readonly: true,
		}, func() {
			os.RemoveAll(dir)
		}, nil
