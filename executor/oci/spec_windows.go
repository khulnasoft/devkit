...
func withGetUserInfoMount() oci.SpecOpts {
	return func(_ context.Context, _ oci.Client, _ *containers.Container, s *specs.Spec) error {
		...
		// The devkit binary registers a re-exec function that is invoked when called with
		...
		// not share any state with the running devkit daemon. In this scenario, we use the re-exec
