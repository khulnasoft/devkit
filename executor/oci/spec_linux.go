...
import (
	...
	"github.com/khulnasoft/devkit/util/entitlements/security"
...
func generateMountOpts(resolvConf, hostsFile string) ([]oci.SpecOpts, error) {
	return []oci.SpecOpts{
		// https://github.com/khulnasoft/devkit/issues/429
...
func cgroupV2NamespaceSupported() bool {
	...
	// See https://github.com/khulnasoft/devkit/issues/4108
