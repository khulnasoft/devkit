...
package moby_devkit_v1_sourcepolicy
...
type Rule struct {
	Action   PolicyAction `protobuf:"varint,1,opt,name=action,proto3,enum=moby.devkit.v1.sourcepolicy.PolicyAction" json:"action,omitempty"`
...
type Selector struct {
	...
	MatchType   MatchType         `protobuf:"varint,2,opt,name=match_type,json=matchType,proto3,enum=moby.devkit.v1.sourcepolicy.MatchType" json:"match_type,omitempty"`
...
type AttrConstraint struct {
	...
	Condition AttrMatch `protobuf:"varint,3,opt,name=condition,proto3,enum=moby.devkit.v1.sourcepolicy.AttrMatch" json:"condition,omitempty"`
}
...
func init() {
	proto.RegisterEnum("moby.devkit.v1.sourcepolicy.PolicyAction", PolicyAction_name, PolicyAction_value)
	proto.RegisterEnum("moby.devkit.v1.sourcepolicy.AttrMatch", AttrMatch_name, AttrMatch_value)
	proto.RegisterEnum("moby.devkit.v1.sourcepolicy.MatchType", MatchType_name, MatchType_value)
	proto.RegisterType((*Rule)(nil), "moby.devkit.v1.sourcepolicy.Rule")
	proto.RegisterType((*Update)(nil), "moby.devkit.v1.sourcepolicy.Update")
	proto.RegisterMapType((map[string]string)(nil), "moby.devkit.v1.sourcepolicy.Update.AttrsEntry")
	proto.RegisterType((*Selector)(nil), "moby.devkit.v1.sourcepolicy.Selector")
	proto.RegisterType((*AttrConstraint)(nil), "moby.devkit.v1.sourcepolicy.AttrConstraint")
	proto.RegisterType((*Policy)(nil), "moby.devkit.v1.sourcepolicy.Policy")
}
