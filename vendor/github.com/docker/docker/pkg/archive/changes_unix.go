...
func statDifferent(oldStat *system.StatT, newStat *system.StatT) bool {
	...
	if oldStat.Mode() != newStat.Mode() ||
		...
		// measure of change. See https://github.com/khulnasoft-lab/docker/issues/9874
		// for a description of the issue with modification time, and
		// https://github.com/khulnasoft-lab/docker/pull/11422 for the change.
		// (Note that in the Windows implementation of this function,
		// modification time IS taken as a change). See
		// https://github.com/khulnasoft-lab/docker/pull/37982 for more information.
