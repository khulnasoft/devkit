...
func init() {
	typeurl.Register((*Vertex)(nil), "github.com/khulnasoft/devkit", "errdefs.Vertex+json")
	typeurl.Register((*Source)(nil), "github.com/khulnasoft/devkit", "errdefs.Source+json")
}
