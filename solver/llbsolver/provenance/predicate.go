...
const (
	DevKitBuildType = "https://khulnasoftproject.org/devkit@v1"
)
...
type ProvenanceMetadata struct {
	...
	DevKitMetadata DevKitMetadata `json:"https://khulnasoftproject.org/devkit@v1#metadata,omitempty"`
	Hermetic       bool           `json:"https://khulnasoftproject.org/devkit@v1#hermetic,omitempty"`
}
