...
type BuildHistoryEvent struct {
	Type                 BuildHistoryEventType `protobuf:"varint,1,opt,name=type,proto3,enum=moby.devkit.v1.BuildHistoryEventType" json:"type,omitempty"`
...
func init() {
	proto.RegisterEnum("moby.devkit.v1.BuildHistoryEventType", BuildHistoryEventType_name, BuildHistoryEventType_value)
	proto.RegisterType((*PruneRequest)(nil), "moby.devkit.v1.PruneRequest")
	proto.RegisterType((*DiskUsageRequest)(nil), "moby.devkit.v1.DiskUsageRequest")
	proto.RegisterType((*DiskUsageResponse)(nil), "moby.devkit.v1.DiskUsageResponse")
	proto.RegisterType((*UsageRecord)(nil), "moby.devkit.v1.UsageRecord")
	proto.RegisterType((*SolveRequest)(nil), "moby.devkit.v1.SolveRequest")
	proto.RegisterMapType((map[string]string)(nil), "moby.devkit.v1.SolveRequest.ExporterAttrsDeprecatedEntry")
	proto.RegisterMapType((map[string]string)(nil), "moby.devkit.v1.SolveRequest.FrontendAttrsEntry")
	proto.RegisterMapType((map[string]*pb.Definition)(nil), "moby.devkit.v1.SolveRequest.FrontendInputsEntry")
	proto.RegisterType((*CacheOptions)(nil), "moby.devkit.v1.CacheOptions")
	proto.RegisterMapType((map[string]string)(nil), "moby.devkit.v1.CacheOptions.ExportAttrsDeprecatedEntry")
	proto.RegisterType((*CacheOptionsEntry)(nil), "moby.devkit.v1.CacheOptionsEntry")
	proto.RegisterMapType((map[string]string)(nil), "moby.devkit.v1.CacheOptionsEntry.AttrsEntry")
	proto.RegisterType((*SolveResponse)(nil), "moby.devkit.v1.SolveResponse")
	proto.RegisterMapType((map[string]string)(nil), "moby.devkit.v1.SolveResponse.ExporterResponseEntry")
	proto.RegisterType((*StatusRequest)(nil), "moby.devkit.v1.StatusRequest")
	proto.RegisterType((*StatusResponse)(nil), "moby.devkit.v1.StatusResponse")
	proto.RegisterType((*Vertex)(nil), "moby.devkit.v1.Vertex")
	proto.RegisterType((*VertexStatus)(nil), "moby.devkit.v1.VertexStatus")
	proto.RegisterType((*VertexLog)(nil), "moby.devkit.v1.VertexLog")
	proto.RegisterType((*VertexWarning)(nil), "moby.devkit.v1.VertexWarning")
	proto.RegisterType((*BytesMessage)(nil), "moby.devkit.v1.BytesMessage")
	proto.RegisterType((*ListWorkersRequest)(nil), "moby.devkit.v1.ListWorkersRequest")
	proto.RegisterType((*ListWorkersResponse)(nil), "moby.devkit.v1.ListWorkersResponse")
	proto.RegisterType((*InfoRequest)(nil), "moby.devkit.v1.InfoRequest")
	proto.RegisterType((*InfoResponse)(nil), "moby.devkit.v1.InfoResponse")
	proto.RegisterType((*BuildHistoryRequest)(nil), "moby.devkit.v1.BuildHistoryRequest")
	proto.RegisterType((*BuildHistoryEvent)(nil), "moby.devkit.v1.BuildHistoryEvent")
	proto.RegisterType((*BuildHistoryRecord)(nil), "moby.devkit.v1.BuildHistoryRecord")
	proto.RegisterMapType((map[string]string)(nil), "moby.devkit.v1.BuildHistoryRecord.ExporterResponseEntry")
	proto.RegisterMapType((map[string]string)(nil), "moby.devkit.v1.BuildHistoryRecord.FrontendAttrsEntry")
	proto.RegisterMapType((map[string]*BuildResultInfo)(nil), "moby.devkit.v1.BuildHistoryRecord.ResultsEntry")
	proto.RegisterType((*UpdateBuildHistoryRequest)(nil), "moby.devkit.v1.UpdateBuildHistoryRequest")
	proto.RegisterType((*UpdateBuildHistoryResponse)(nil), "moby.devkit.v1.UpdateBuildHistoryResponse")
	proto.RegisterType((*Descriptor)(nil), "moby.devkit.v1.Descriptor")
	proto.RegisterMapType((map[string]string)(nil), "moby.devkit.v1.Descriptor.AnnotationsEntry")
	proto.RegisterType((*BuildResultInfo)(nil), "moby.devkit.v1.BuildResultInfo")
	proto.RegisterMapType((map[int64]*Descriptor)(nil), "moby.devkit.v1.BuildResultInfo.ResultsEntry")
	proto.RegisterType((*Exporter)(nil), "moby.devkit.v1.Exporter")
	proto.RegisterMapType((map[string]string)(nil), "moby.devkit.v1.Exporter.AttrsEntry")
}
...
func (c *controlClient) DiskUsage(ctx context.Context, in *DiskUsageRequest, opts ...grpc.CallOption) (*DiskUsageResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/moby.devkit.v1.Control/DiskUsage", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *controlClient) Prune(ctx context.Context, in *PruneRequest, opts ...grpc.CallOption) (Control_PruneClient, error) {
	stream, err := c.cc.NewStream(ctx, &_Control_serviceDesc.Streams[0], "/moby.devkit.v1.Control/Prune", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *controlClient) Solve(ctx context.Context, in *SolveRequest, opts ...grpc.CallOption) (*SolveResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/moby.devkit.v1.Control/Solve", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *controlClient) Status(ctx context.Context, in *StatusRequest, opts ...grpc.CallOption) (Control_StatusClient, error) {
	stream, err := c.cc.NewStream(ctx, &_Control_serviceDesc.Streams[1], "/moby.devkit.v1.Control/Status", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *controlClient) Session(ctx context.Context, opts ...grpc.CallOption) (Control_SessionClient, error) {
	stream, err := c.cc.NewStream(ctx, &_Control_serviceDesc.Streams[2], "/moby.devkit.v1.Control/Session", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *controlClient) ListWorkers(ctx context.Context, in *ListWorkersRequest, opts ...grpc.CallOption) (*ListWorkersResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/moby.devkit.v1.Control/ListWorkers", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *controlClient) Info(ctx context.Context, in *InfoRequest, opts ...grpc.CallOption) (*InfoResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/moby.devkit.v1.Control/Info", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *controlClient) ListenBuildHistory(ctx context.Context, in *BuildHistoryRequest, opts ...grpc.CallOption) (Control_ListenBuildHistoryClient, error) {
	stream, err := c.cc.NewStream(ctx, &_Control_serviceDesc.Streams[3], "/moby.devkit.v1.Control/ListenBuildHistory", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *controlClient) UpdateBuildHistory(ctx context.Context, in *UpdateBuildHistoryRequest, opts ...grpc.CallOption) (*UpdateBuildHistoryResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/moby.devkit.v1.Control/UpdateBuildHistory", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Control_DiskUsage_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/moby.devkit.v1.Control/DiskUsage",
	}
...
func _Control_Solve_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/moby.devkit.v1.Control/Solve",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Control_ListWorkers_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/moby.devkit.v1.Control/ListWorkers",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Control_Info_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/moby.devkit.v1.Control/Info",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Control_UpdateBuildHistory_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/moby.devkit.v1.Control/UpdateBuildHistory",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Control_serviceDesc = grpc.ServiceDesc{
	ServiceName: "moby.devkit.v1.Control",
