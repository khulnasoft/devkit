...
type SolveRequest struct {
	...
	Entitlements            []github_com_moby_devkit_util_entitlements.Entitlement `protobuf:"bytes,9,rep,name=Entitlements,proto3,customtype=github.com/khulnasoft/devkit/util/entitlements.Entitlement" json:"Entitlements,omitempty"`
