...
import (
	...
	github_com_moby_devkit_util_entitlements "github.com/khulnasoft/devkit/util/entitlements"
...
func (m *SolveRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 9:
			...
			m.Entitlements = append(m.Entitlements, github_com_moby_devkit_util_entitlements.Entitlement(dAtA[iNdEx:postIndex]))
			iNdEx = postIndex
		case 10:
			if wireType != 2 {
