...
func run() error {
	...
	buildctl, err := gb.BuildExe(gobuild.BuildOpt{
		Source:    src,
		MountPath: "/go/src/github.com/khulnasoft/devkit",
		Pkg:       "github.com/khulnasoft/devkit/cmd/buildctl",
		BuildTags: []string{},
	})
	if err != nil {
		return err
	...
	devkitd, err := gb.BuildExe(gobuild.BuildOpt{
		Source:    src,
		MountPath: "/go/src/github.com/khulnasoft/devkit",
		Pkg:       "github.com/khulnasoft/devkit/cmd/devkitd",
		BuildTags: []string{},
	})
	if err != nil {
		return err
