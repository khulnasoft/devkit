...
func TestParseURL(t *testing.T) {
	tests := []struct {
		...
		{
			url: "http://github.com/khulnasoft/devkit",
			result: GitURL{
				Scheme: HTTPProtocol,
				Host:   "github.com",
				Path:   "/khulnasoft/devkit",
			},
		},
		{
			url: "https://github.com/khulnasoft/devkit",
			result: GitURL{
		...
		{
			url: "http://github.com/khulnasoft/devkit#v1.0.0",
			result: GitURL{
				Scheme:   HTTPProtocol,
				Host:     "github.com",
				Path:     "/khulnasoft/devkit",
		...
		{
			url: "http://github.com/khulnasoft/devkit#v1.0.0:subdir",
			result: GitURL{
				Scheme:   HTTPProtocol,
				Host:     "github.com",
				Path:     "/khulnasoft/devkit",
		...
		{
			url: "http://foo:bar@github.com/khulnasoft/devkit#v1.0.0",
			result: GitURL{
				Scheme:   HTTPProtocol,
				Host:     "github.com",
				Path:     "/khulnasoft/devkit",
		...
		{
			url: "ssh://git@github.com/khulnasoft/devkit.git",
			result: GitURL{
				Scheme: SSHProtocol,
				Host:   "github.com",
				Path:   "/khulnasoft/devkit.git",
				User:   url.User("git"),
			},
		},
		{
			url: "ssh://git@github.com:22/khulnasoft/devkit.git",
			result: GitURL{
				Scheme: SSHProtocol,
				Host:   "github.com:22",
				Path:   "/khulnasoft/devkit.git",
		...
		{
			url: "git@github.com:khulnasoft/devkit.git",
			result: GitURL{
				Scheme: SSHProtocol,
				Host:   "github.com",
				Path:   "khulnasoft/devkit.git",
		...
		{
			url: "git@github.com:khulnasoft/devkit.git#v1.0.0",
			result: GitURL{
				Scheme:   SSHProtocol,
				Host:     "github.com",
				Path:     "khulnasoft/devkit.git",
		...
		{
			url: "git@github.com:khulnasoft/devkit.git#v1.0.0:hack",
			result: GitURL{
				Scheme:   SSHProtocol,
				Host:     "github.com",
				Path:     "khulnasoft/devkit.git",
		...
		{
			url: "httpx://github.com/khulnasoft/devkit",
			err: true,
		},
		{
			url: "HTTP://github.com/khulnasoft/devkit",
