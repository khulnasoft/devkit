...
import (
	...
	"github.com/khulnasoft/devkit/util/sshutil"
...
// "https://github.com/khulnasoft/devkit.git"), as well as SCP-like URLs (e.g.
// "git@github.com:khulnasoft/devkit.git").
//
...
// GitURLFragment is the devkit-specific metadata extracted from the fragment
// of a remote URL.
