...
func TestIsImplicitSSHTransport(t *testing.T) {
	require.False(t, IsImplicitSSHTransport("http://github.com/khulnasoft/devkit"))
	require.False(t, IsImplicitSSHTransport("github.com/khulnasoft/devkit"))
	require.False(t, IsImplicitSSHTransport("github.com:khulnasoft/devkit.git"))
	...
	require.True(t, IsImplicitSSHTransport("git@github.com:khulnasoft/devkit.git"))
...
func TestParseSCPStyleURL(t *testing.T) {
	tests := []struct {
		...
		{
			url:      "git@github.com:khulnasoft/devkit.git#v1.0",
			host:     "github.com",
			path:     "khulnasoft/devkit.git",
			user:     "git",
			fragment: "v1.0",
