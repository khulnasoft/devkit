...
import (
	...
	sessionauth "github.com/khulnasoft/devkit/session/auth"
	log "github.com/khulnasoft/devkit/util/bklog"
		...
		if err != nil {
			...
			if errors.As(err, &errStatus) {
				...
				if (errStatus.StatusCode == 405 && to.Username != "") || errStatus.StatusCode == 404 || errStatus.StatusCode == 401 {
					resp, err := auth.FetchTokenWithOAuth(ctx, ah.client, hdr, "devkit-client", to)
					if err != nil {
						return nil, err
					}
					if resp.ExpiresIn == 0 {
