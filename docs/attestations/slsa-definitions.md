...
The `buildType` field is set to `https://buildkit.khulnasoft.com/devkit@v1` can be
used to determine the structure of the provenance content.

```json
    "buildType": "https://buildkit.khulnasoft.com/devkit@v1",
```
...
## `metadata.https://buildkit.khulnasoft.com/devkit@v1#hermetic`
...
```json
    "metadata": {
      "https://buildkit.khulnasoft.com/devkit@v1#hermetic": true,
      ...
    },
```

## `metadata.https://buildkit.khulnasoft.com/devkit@v1#metadata`
...
```json
    "metadata": {
      "https://buildkit.khulnasoft.com/devkit@v1#metadata": {
        "source": {...},
        "layers": {...},
        "vcs": {...},
      },
