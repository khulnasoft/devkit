...
import (
	...
	"github.com/khulnasoft/devkit/worker/tests"
...
func checkRequirement(t *testing.T) {
	...
	if _, err := exec.LookPath("runc"); err != nil {
		if _, err := exec.LookPath("devkit-runc"); err != nil {
...
func TestRuncWorker(t *testing.T) {
	...
	//Verifies fix for issue https://github.com/khulnasoft/devkit/issues/429
