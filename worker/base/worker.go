...
import (
	...
	"github.com/khulnasoft/devkit/cache/metadata"
	...
	"github.com/khulnasoft/devkit/exporter"
	imageexporter "github.com/khulnasoft/devkit/exporter/containerimage"
	localexporter "github.com/khulnasoft/devkit/exporter/local"
	ociexporter "github.com/khulnasoft/devkit/exporter/oci"
	tarexporter "github.com/khulnasoft/devkit/exporter/tar"
	...
	containerdsnapshot "github.com/khulnasoft/devkit/snapshot/containerd"
	"github.com/khulnasoft/devkit/snapshot/imagerefchecker"
	"github.com/khulnasoft/devkit/solver"
	"github.com/khulnasoft/devkit/solver/llbsolver/mounts"
	"github.com/khulnasoft/devkit/solver/llbsolver/ops"
	"github.com/khulnasoft/devkit/solver/pb"
	"github.com/khulnasoft/devkit/source"
	"github.com/khulnasoft/devkit/source/containerimage"
	"github.com/khulnasoft/devkit/source/git"
	"github.com/khulnasoft/devkit/source/http"
	"github.com/khulnasoft/devkit/source/local"
	...
	"github.com/khulnasoft/devkit/util/progress/controller"
...
const labelCreatedAt = "devkit/createdat"
...
func NewWorker(ctx context.Context, opt WorkerOpt) (*Worker, error) {
	...
	leases, err := opt.LeaseManager.List(ctx, "labels.\"devkit/lease.temporary\"")
	if err != nil {
		return nil, err
	}
...
func (w *Worker) FromRemote(ctx context.Context, remote *solver.Remote) (ref cache.ImmutableRef, err error) {
	...
	for i, desc := range remote.Descriptors {
		...
		if v, ok := desc.Annotations["devkit/description"]; ok {
			descr = v
		}
